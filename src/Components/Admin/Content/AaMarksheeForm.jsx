    ...
    <div className="max-w-4xl mx-auto p-4 bg-white shadow-md">
      ...
      <form onSubmit={generateMarksheet}>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block font-semibold">Assessor Registration No.:</label>
            <input type="text" name="trainerRegNo" value={formData.assessorRegNo} onChange={handleChange} className="w-full p-2 border border-gray-300 rounded" />
          </div>
          <div>
     ...
     <div className='mt-4'> <AaMarksheet data={formData}/></div>
