                    ...
                    <Card className="sm:col-span-2">
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription className="max-w-lg text-balance leading-relaxed">
                                Meet our experienced team of experts who are dedicated to helping you.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                        ...
                                        <TableHeader>
                                            <TableRow>
                                                ...
                                                <TableHead className="cursor-pointer" onClick={() => handleSort("phoneNumber")}>
                                                    Phone {sortColumn === "phoneNumber" && <span className="ml-2">{sortDirection === "asc" ? "\u25B2" : "\u25BC"}</span>}
                                                </TableHead>
                                                <TableHead className="cursor-pointer" onClick={() => handleSort("sector")}>
                                                    Sector {sortColumn === "sector" && <span className="ml-2">{sortDirection === "asc" ? "\u25B2" : "\u25BC"}</span>}
                                                </TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            {sortedTeachers.map((teacher) => (
                                                <TableRow key={teacher._id} className="transition-transform duration-300">
                                                    <TableCell>
